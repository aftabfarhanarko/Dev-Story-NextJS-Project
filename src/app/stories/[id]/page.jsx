...
const StordDetlise = async ({ params }) => {
  ...
  const story = devStorys.find(story => story.id == id);
  console.log(story);
  
  return  <div className="max-w-3xl mx-auto bg-white shadow-md rounded-lg p-6 border border-gray-200">
      {/* Top Section */}
      <div className="flex items-center gap-5">
        ...
        />
        <div>
          <h1 className="text-2xl font-semibold text-black">{story.name}</h1>
      ...
      {/* Story */}
      <div className="mt-6">
        <h2 className="text-xl font-semibold mb-2 text-black">Learning Story</h2>
        <p className="text-gray-700 leading-relaxed">{story.story}</p>
      </div>

      {/* About */}
      <div className="mt-6">
        <h2 className="text-xl font-semibold mb-2 text-black">About Developer</h2>
